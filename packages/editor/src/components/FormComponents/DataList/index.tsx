/*
 * @Author: jiudehuiyi
 * @Date: 2022-09-27 14:36:46
 * @LastEditors: Please set LastEditors
 * @LastEditTime: 2022-09-27 14:45:58
 * @Description:
 */
...
import type { TDataListDefaultType, TDataListDefaultTypeItem } from '../types';
...
const List = function (props: DataListType) {
  ...
  const handleDel = (id: string) => {
    if (value && onChange) {
      const newVal = value.filter((item) => id !== item.id);
      onChange(newVal);
    }
  };
